...
if(isset($_POST['submit'])){
    ...
    if($rowCount == 2){
        ...
        $update = " UPDATE [Milestones] SET milestone_title = '$title', milestone_cost = '$cost', milestone_summary = '$summary' WHERE milestone_id = '$milestone_id' ";
        $conn->query($update);
...
<head>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(".btnMilestoneDetails").click(function(){
                $(".mileStoneDetails").toggleClass("active");
            });
            $(".btnEditProject").click(function(){
                $(".editProject").toggleClass("active");
            });
            $(".btnEditMilestone").click(function(){
                $(".editMilestone").toggleClass("active");
            });
...
<body>
                                            ...
                                            <div class="ribbon-content">
                                                <h5 class="media-heading text-info font-light">
                                                    ...
                                                    <div class="float-right">
                                                        <small>
                                                            <a href="#" class="btn btn-sm btn-outline-primary btnEditMilestone">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" value="<?= $dataProject['project_name'] ?>" required="" placeholder="Project Name">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="number" min="0" id="budget" name="budget" value="<?= $dataProject['project_budget'] ?>" placeholder="Project Budget">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control date hasDatepicker" data-provide="datepicker" data-date-format="yy-mm-dd" type="date" id="start_date" name="start_date" value="<?= $dataProject['project_start_date'] ?>" autocomplete="off" required="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="end_date">End Date</label>
                                    <input class="form-control date hasDatepicker" data-provide="datepicker" data-date-format="yy-mm-dd" type="date" id="end_date" name="end_date" value="<?= $dataProject['project_end_date'] ?>" autocomplete="off" required="required">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="description">Description</label>
                                    <textarea class="form-control" id="description" name="description"><?= $dataProject['project_description'] ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal fade show editMilestone" style="display: block; padding-right: 17px;">
        <div class="modal-dialog modal-undefined">
            <div class="modal-content ">
                <div class="modal-header">
                    ...
                    <form class="pl-3 pr-3" method="post" action="">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label for="milestone-title">Milestone Title</label>
                                    <input type="text" class="form-control form-control-light" placeholder="Enter Title" value="<?= $dataMilestone['milestone_title'] ?>" name="title" required="">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="milestone-title">Milestone Cost</label>
                            <input type="number" class="form-control form-control-light" placeholder="Enter Cost" value="<?= $dataMilestone['milestone_cost'] ?>" min="0" name="cost" required="">
                        </div>
                        <div class="form-group">
                            <label for="task-summary">Summary</label>
                            <textarea class="form-control form-control-light" rows="3" name="summary"><?= $dataMilestone['milestone_summary'] ?></textarea>
                        </div>
                        <div class="text-right">
